  ...
  const transformContent = (contentArray: any[]) => {
    ...
    sortedContent.forEach((content) => {
      if (content.content_type === "Movie") {
        ...
        // If content already has seasonNumber (pre-transformed), use it directly
        if (content.seasonNumber && content.web_series?.seasons) {
          const season = content.web_series.seasons[content.seasonNumber - 1];
          transformedContent.push({
            id: content.id,
            title: content.title,
            ...
            originalContentId: content.originalContentId || content.id,
          });
