                  ...
                  <div className="flex items-center space-x-3 flex-wrap">
                    ...
                    {content.score && (
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-foreground font-medium text-xs">{content.score}</span>
                      </div>
                    )}
                    {getSeasonsOrEpisodes() && (
                      <span className="text-muted-foreground font-medium text-xs">{getSeasonsOrEpisodes()}</span>
                    )}
                  </div>

                  {content.description && (
                    <div className="mt-4">
                      <p className="text-foreground/90 leading-relaxed text-sm font-normal">
                        {content.description}
                      </p>
                    </div>
                  )}
                  ...
                  <div className="space-y-4 border-t border-border/30 pt-6">
                    ...
                    {content.directors && content.directors.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(Array.isArray(content.directors) ? content.directors : content.directors.split(',')).map((director, index) => (
                    ...
                    {content.writers && content.writers.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(Array.isArray(content.writers) ? content.writers : content.writers.split(',')).map((writer, index) => (
                    ...
                    {content.cast && content.cast.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(Array.isArray(content.cast) ? content.cast : content.cast.split(',')).map((cast, index) => (
